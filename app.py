...
# ── Load secrets ──────────────────────────────────────────────
# Reads from .streamlit/secrets.toml locally
...
Summarize the key technical specifications: equipment name, location, quantity, priority, and technical requirements. Be specific and factual."""

    elif is_manual:
        prompt = f"""You are a medical equipment service expert for hospitals in Nepal.
Based on the service manual sections below, answer the query.
...
<div style='text-align:center;color:#334155;font-size:0.8rem;font-family:IBM Plex Mono,monospace;'>
    NIC MedSearch · Qdrant Cloud + Groq + Streamlit · Always On · Free
</div>
""", unsafe_allow_html=True)